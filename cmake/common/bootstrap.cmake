...
string(JSON _packageVersion ERROR_VARIABLE _packageVersion_error GET ${buildspec} packageVersion)
if(_packageVersion_error)
  set(_packageVersion "${_version}")
endif()
...
set(PLUGIN_VERSION ${_packageVersion})
